<?php 
/**
 * Blogbanner Page Controller
 * @category  Controller
 */
class BlogbannerController extends SecureController{
	function __construct(){
		parent::__construct();
		$this->tablename = "blogbanner";
	}
	/**
     * List page records
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		$this->render_view("blogbanner/list.php", $data); //render the full page
	}
	/**
     * View record detail 
	...
	function view($rec_id = null, $value = null){
		...
		return $this->render_view("blogbanner/view.php", $record);
	}
	/**
     * List page records
     * @param $fieldname (filter record by a field) 
     ...
     * @return BaseView
     */
	function banner($fieldname = null , $fieldvalue = null){
		$request = $this->request;
		$db = $this->GetModel();
		$tablename = $this->tablename;
		$fields = array("id", 
