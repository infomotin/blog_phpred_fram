                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <select required=""  id="ctrl-tag" name="tag[]"  placeholder="Select a value ..." multiple data-max-items="3"  class="selectize"  data-url="api/json/articles_tag_value_exist/" data-loading-msg="Checking availability ..." data-available-msg="Available" data-unavailable-msg="Not available">
                                                            <option value="">Select a value ...</option>
                                                            <?php 
                                                            $tag_options = $comp_model -> articles_tag_option_list();
                                                            if(!empty($tag_options)){
                                                            foreach($tag_options as $option){
                                                            $value = (!empty($option['value']) ? $option['value'] : null);
                                                            $label = (!empty($option['label']) ? $option['label'] : $value);
                                                            $selected = $this->set_field_selected('tag',$value, "");
                                                            ?>
