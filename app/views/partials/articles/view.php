                            ...
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    ...
                                    <tr  class="td-publisher">
                                        ...
                                        <td class="value">
                                            <a size="sm" class="btn btn-sm btn-primary page-modal" href="<?php print_link("masterdetail/index/articles/user/id/" . urlencode($data['publisher'])) ?>">
                                                <i class="icon-eye"></i> <?php echo $data['user_username'] ?>
                                            </a>
                                        </td>
                                    </tr>
                                    ...
                                    <tr  class="td-tag">
                                        ...
                                        <td class="value">
                                            <a size="sm" class="btn btn-sm btn-primary page-modal" href="<?php print_link("masterdetail/index/articles/tags/id/" . urlencode($data['tag'])) ?>">
                                                <i class="icon-eye"></i> <?php echo $data['tags_name'] ?>
                                            </a>
                                        </td>
                                    </tr>
                                </tbody>
                                    ...
                                    <a class="dropdown-item export-link-btn" data-format="print" href="<?php print_link($export_print_link); ?>" target="_blank">
                                        ...
                                        <a class="dropdown-item export-link-btn" data-format="pdf" href="<?php print_link($export_pdf_link); ?>" target="_blank">
                                            ...
                                            <a class="dropdown-item export-link-btn" data-format="word" href="<?php print_link($export_word_link); ?>" target="_blank">
                                                ...
                                                <a class="btn btn-sm btn-info"  href="<?php print_link("articles/edit/$rec_id"); ?>">
                                                    <i class="icon-pencil"></i> Edit
                                                </a>
                                                <a class="btn btn-sm btn-danger record-delete-btn mx-1"  href="<?php print_link("articles/delete/$rec_id/?csrf_token=$csrf_token&redirect=$current_page"); ?>" data-prompt-msg="Are you sure you want to delete this record?" data-display-style="modal">
